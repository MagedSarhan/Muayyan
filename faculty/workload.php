<?php
/** MOEEN  - Faculty Workload/Assessment Density */
...
<main class="main-content">
    <div class="content-wrapper">
        ...
        <p class="text-muted mb-4">View assessment distribution across weeks to identify periods of high workload for
            students.</p>
        ...
        <?php if (empty($weeks)): ?>
            <div class="empty-state"><i class="fas fa-calendar-check"></i>
                ...
                <p>No assessments scheduled for the next 30 days.</p>
            </div>
        <?php endif; ?>
    </div>
</main>
