            ...
            <?php foreach ($sections as $s): ?>
                <div class="col-lg-4 col-md-6">
                    <div class="course-card">
                        ...
                        <div class="course-info mb-1"><i class="fas fa-clipboard-list"></i> <?= $s['assessment_count'] ?>
                            Assessments</div>
                        ...
                        <div class="d-flex gap-2">
                            <a href="<?= BASE_URL ?>/faculty/assessments.php?section=<?= $s['id'] ?>"
                                class="btn btn-sm btn-outline-primary flex-fill"><i
                                    class="fas fa-clipboard-list me-1"></i>Assessments</a>
