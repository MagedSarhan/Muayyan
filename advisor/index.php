    ...
    <div class="content-wrapper">
        ...
        <div class="row g-3 mb-4">
            <div class="col-xl-3 col-md-6">
                <div class="stat-card gradient-1">
                    ...
                    <div class="stat-value" data-count="<?= $assignedStudents ?>"><?= $assignedStudents ?></div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card gradient-4">
                    ...
                    <div class="stat-value" data-count="<?= $atRiskCount ?>"><?= $atRiskCount ?></div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card gradient-3">
                    ...
                    <div class="stat-value" data-count="<?= $pendingRequests ?>"><?= $pendingRequests ?></div>
                    <div class="stat-label">Pending Requests</div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="stat-card gradient-2">
                    <div class="stat-icon success"><i class="fas fa-bell"></i></div>
                    <div class="stat-value" data-count="<?= $unreadAlerts ?>"><?= $unreadAlerts ?></div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="card h-100">
                    <div class="card-header">
                        <h6><i class="fas fa-chart-pie me-2"></i>Student Risk Distribution</h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-8">
                <div class="card h-100">
                    <div class="card-header">
                        <h6><i class="fas fa-users me-2"></i>My Students</h6><a
                            href="<?= BASE_URL ?>/advisor/students.php" class="btn btn-sm btn-outline-primary">View
                            All</a>
                    </div>
                                ...
                                <tbody>
                                    <?php foreach ($students as $st):
                                        ...
                                        <tr>
                                            ...
                                            <td><span
                                                    class="grade-cell <?= $risk['avg_grade'] >= 80 ? 'high' : ($risk['avg_grade'] >= 60 ? 'mid' : 'low') ?>"><?= $risk['avg_grade'] ?>%</span>
                                            </td>
                                            <td><i
                                                    class="fas fa-<?= $risk['trend'] === 'improving' ? 'arrow-up text-success' : ($risk['trend'] === 'declining' ? 'arrow-down text-danger' : 'minus text-secondary') ?>"></i>
                                            </td>
                                            <td><span class="risk-badge risk-<?= $risk['level'] ?>"><i
                                                        class="fas <?= $badge['icon'] ?> me-1"></i><?= $badge['label'] ?></span>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
            ...
            <div class="col-lg-6">
                ...
                <?php foreach ($alerts as $al): ?>
                    <div class="alert-card severity-<?= $al['severity'] ?>">
                        ...
                        <div class="alert-message"><?= e($al['student_name']) ?> — <?= e(substr($al['message'], 0, 100)) ?>...
                        </div>
            ...
            <div class="col-lg-6">
                ...
                <?php foreach ($requests as $req):
                    ...
                    <div class="request-item">
                        ...
                        <div class="request-meta"><span><i
                                    class="fas fa-user me-1"></i><?= e($req['student_name']) ?></span><span><i
                                    class="fas fa-clock me-1"></i><?= timeAgo($req['created_at']) ?></span></div>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
