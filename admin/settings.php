                    ...
                    <?php foreach ($settings as $s): ?>
                        <div class="row mb-3 align-items-center">
                            <div class="col-md-4"><label
                                    class="form-label fw-semibold"><?= e(ucwords(str_replace('_', ' ', $s['setting_key']))) ?></label><small
                                    class="d-block text-muted"><?= e($s['description']) ?></small></div>
                            <div class="col-md-8"><input type="text" name="settings[<?= e($s['setting_key']) ?>]"
                                    class="form-control" value="<?= e($s['setting_value']) ?>"></div>
                        </div>
                    <?php endforeach; ?>
                    <hr>
