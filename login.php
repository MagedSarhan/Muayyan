    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-card">
            ...
            <div class="demo-credentials">
                ...
                <div class="cred-item"><span><strong>Admin:</strong> admin@MOEEN .edu</span></div>
                <div class="cred-item"><span><strong>Faculty:</strong> sara.faculty@MOEEN .edu</span></div>
                <div class="cred-item"><span><strong>Advisor:</strong> nora.advisor@MOEEN .edu</span></div>
                <div class="cred-item"><span><strong>Student:</strong> mohammed.stu@MOEEN .edu</span></div>
                <div class="cred-item"><span><strong>Password:</strong> password</span></div>
            </div>

            <div class="auth-footer">
                <p>&copy; <?= date('Y') ?> MOEEN . All rights reserved.</p>
            </div>
        </div>
    </div>
