...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $advisor) {
    ...
    header('Location: ' . BASE_URL . '/student/contact.php');
    exit;
}
    ...
    <div class="content-wrapper">
        <?php if ($flash): ?>
            <div class="alert alert-<?= $flash['type'] === 'success' ? 'success' : 'danger' ?> alert-dismissible fade show">
                <i
                    class="fas fa-<?= $flash['type'] === 'success' ? 'check' : 'times' ?>-circle me-2"></i><?= e($flash['message']) ?>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <?php if ($advisor): ?>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newRequestModal"><i
                        class="fas fa-plus me-1"></i> New Request</button>
            <?php endif; ?>
        </div>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center gap-3">
                        <div class="student-avatar" style="width:55px;height:55px;font-size:1.1rem">
                            <?= getInitials($advisor['name']) ?></div>
                        <div>
                            <h6 class="fw-bold mb-0"><?= e($advisor['name']) ?></h6>
                            <small class="text-muted">Academic Advisor &bull; <?= e($advisor['department']) ?></small><br>
                            <small class="text-muted"><i class="fas fa-envelope me-1"></i><?= e($advisor['email']) ?> &bull;
                                <i class="fas fa-phone me-1"></i><?= e($advisor['phone']) ?></small>
                        </div>
                    </div>
                </div>
            </div>
        <?php else: ?>
            <div class="alert alert-warning"><i class="fas fa-info-circle me-2"></i>No advisor assigned yet. Please contact
        ...
        <?php if (empty($requests)): ?>
            <div class="empty-state"><i class="fas fa-envelope-open"></i>
                <h5>No Requests Yet</h5>
                <p>You haven't sent any contact requests to your advisor.</p>
            </div>
        <?php endif; ?>
                ...
                <div class="card-body">
                    ...
                    <?php if (!empty($attachments)): ?>
                        <div class="mb-3">
                            <?php foreach ($attachments as $att): ?>
                                <span class="badge bg-light text-dark border me-1"><i
                                        class="fas fa-paperclip me-1"></i><?= e($att['file_name']) ?>
                                    <small>(<?= round($att['file_size'] / 1024) ?>KB)</small></span>
                            <?php endforeach; ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (!empty($replies)): ?>
                        ...
                        <?php foreach ($replies as $rp): ?>
                            <div class="d-flex gap-2 mb-2 p-2 rounded"
                                style="background:<?= $rp['role'] === 'student' ? 'var(--primary-25)' : 'var(--gray-50)' ?>">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">(<?= ucfirst($rp['role']) ?>) &bull;
                    ...
                    <?php if ($req['status'] !== 'closed'): ?>
                        ...
                        <form method="POST" class="d-flex gap-2">
                            ...
                            <textarea name="message" class="form-control" rows="1" placeholder="Write a reply..."
                                required></textarea>
        ...
        <div class="modal-content">
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="message" class="form-control" rows="5" required
                            placeholder="Describe your academic concern, question, or request in detail..."></textarea>
                    </div>
                    <div class="row g-3">
                        <div class="col-md-6">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fas fa-paper-plane me-1"></i> Send
                        Request</button>
                </div>
            </form>
        </div>
