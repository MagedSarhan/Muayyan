...
<div class="content-wrapper">
    <h5 class="mb-4 fw-bold"><i class="fas fa-book-open me-2 text-primary"></i>My Courses — <?= CURRENT_SEMESTER ?></h5>
    <div class="row g-3">
    <?php foreach ($courses as $c): $progress = $c['assess_count'] > 0 ? round(($c['graded_count']/$c['assess_count'])*100) : 0; ?>
    <div class="col-lg-4 col-md-6">
        <div class="course-card">
            ...
            <div class="course-info mb-3"><i class="fas fa-star"></i> <?= $c['credit_hours'] ?> Credit Hours</div>
            <div class="d-flex justify-content-between mb-1" style="font-size:.75rem"><span>Progress</span><span><?= $c['graded_count'] ?>/<?= $c['assess_count'] ?> assessed</span></div>
            <div class="progress"><div class="progress-bar primary" style="width:<?= $progress ?>%"></div></div>
        </div>
    </div>
    <?php endforeach; ?>
    </div>
